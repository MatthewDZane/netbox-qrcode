...
#             url_resized ='http://localhost:8000/media/image-attachments/resized{}.png'.format(device.name)
...
#             url_resized ='http://localhost:8000/media/image-attachments/resized{}.png'.format(rack.name)
...
#             url_resized ='http://localhost:8000/media/image-attachments/resized{}.png'.format(cable.name)
