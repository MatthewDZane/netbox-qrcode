...
def get_qr_text(size, text, font='ArialMT'):
    ...
    while flag:
        ...
        try:
            fnt = ImageFont.truetype('/source/netbox_qrcode_ui/fonts/ArialMT.ttf',font_size)
    ...
    files = os.listdir('/source/netbox_qrcode_ui/') + os.listdir('/source/netbox_qrcode_ui/fonts')
